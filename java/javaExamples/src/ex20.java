...
//3. 생성자함수 호출시 생성될 때 인터턴스를 의미
//4. 화살표 함수 : 자신을 감싸는 외부 범위 this 를 불려받음.
...
//public static BallFactory ballFactory2 = null; //예전
...
public class ex20 {
    public static void main(String[] args) {
        ...
        //static 예약어
        //non-static 변수 : 일반 변수 -> Heap영역(희발성)
        //               : 로컬 변수 -> Stack영역(희발성)
        //static 변수 : 정적 변수(주소값이 고정되었다는 느낌으로보면됨) -> Static영역(메소드(코드)영역)
        //사용하는 이유 : 1. 시작점(Entry Point)를 지정할 때 사용
        //              2. 중요한 데이터를 안정적으로 저장할 때
        //                 (전역변수 - 프로그램전체에서 접근 가능한 변수/함수)
        ...
        //C언어에서 모든 변수가 전역변수였다. -> 도둑(버그)를 잡기 업렵다
