...
CREATE TABLE vm2.product(
                            ...
                            product_limit_date DATE DEFAULT (CURRENT_DATE) -- 괄호가 필수입니다. -- 유통가능일자
);
...
-- 데이터 추가
insert INTO vm2.product values (0, '불고기버거', 1000, '2023-12-25');

-- 데이터 조회
SELECT * FROM vm2.product;

-- 데이터 수정
UPDATE vm2.product SET product_price = 2000 WHERE product_no = 1;
